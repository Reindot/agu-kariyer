...
class SurveyQuestions4 extends StatefulWidget {
  @override
  _SurveyQuestions4State createState() => _SurveyQuestions4State();
}

class _SurveyQuestions4State extends State<SurveyQuestions4> {
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. Kariyer Danışmanlığı üçüncü görüşmesi hakkındaki izlenimleriniz nelerdir?"
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "1. Danışanın kariyer planı ve hedeflerini belirlemesi üzerine konuşabildiniz mi?"
                                  " Danışan açısından verimli bir çalışma olduğunu düşünüyor musunuz?",
                              style: TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                              ),
                      ...
                      Container(
                        ...
                        child: Column(
                          children: <Widget>[
                            Text(
                              "2. Kariyer Danışmanlığı dördüncü görüşmesi hakkındaki izlenimleriniz nelerdir?"
                                  " Danışanda üçüncü görüşmeden bu yana gelişme / farkındalık gözlemlediniz mi?",
                              style: TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.bold,
                              ),
